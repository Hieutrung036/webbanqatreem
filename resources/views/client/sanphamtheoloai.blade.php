                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="sidebar_widget shop_c">
                                ...
                                <div class="layere_categorie">
                                    <ul>
                                        @if ($loaisanpham && $loaisanpham->isNotEmpty())
                                            @foreach ($loaisanpham as $item)
                                                <!-- Sử dụng $item thay vì $lsp -->
                                                <li>
                                                    <!-- Sửa id của input để đảm bảo nó duy nhất -->
                                                    <input id="acces-lsp-{{ $item->idlsp }}" type="checkbox"
                                                        class="filter-checkbox" data-idlsp="{{ $item->idlsp }}">

                                                    <!-- Sửa for của label để trỏ đúng vào id của input -->
                                                    <label for="acces-lsp-{{ $item->idlsp }}">{{ $item->ten }}</label>
                                                </li>
                                            @endforeach
                                        @else
                                            <p>Không có loại sản phẩm nào trong danh mục này.</p>
                                        @endif
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="layere_categorie">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <input type="checkbox" class="filter-checkbox"
                                                data-price-range="500000,999999999">
                                    ...
                                    <div class="tab-pane fade show active" id="large" role="tabpanel">
                                        <div class="row" id="product-list-grid">
                                            @foreach ($sanpham as $sp)
                                                <div class="col-lg-4 col-md-6 product-item" data-id="{{ $sp->idsp }}"
                                                    ...
                                                    <div class="single_product">
                                                        <div class="product_thumb">
                                                            ...
                                                            <div class="img_icone">
                                                                ...
                                                                @if ($title == 'Sản phẩm nổi bật' && $sp->noibat == 1)
                                                                    ...
                                                                    <img src="{{ asset('client/img/cart/span-hot.png') }}"
                                                                        alt="featured" />
                                                            ...
                                                            <span style="display: flex; align-items: center;">
                                                                @if ($sp->giamgia->phantram > 0)
                                                                    <span class="price-new"
                                                                        style="color: red; font-size: 20px; font-weight: bold; margin-right: 10px; padding-left: 50px">
                                                                ...
                                                                @else
                                                                    <span class="price-new"
                                                                        style="font-size: 20px; padding-left: 80px">
                                                                        {{ number_format($sp->gia) }} đ
                                                                    </span>
                                                                @endif
                                                            </span>
                                                        ...
                                                        <div class="product_info">
                                                            <ul>
                                                                <li><a href="{{ route('chitietsanpham', ['slug' => Str::slug($sp->ten, '-') . '-' . $sp->idsp]) }}"
                                                                        title=" Mua ngay ">Mua ngay</a>
                                                                </li>

                                                                <li><a href="#" class="quick-view-btn"
                                                                        data-id="{{ $sp->idsp }}" data-toggle="modal"
                                                                        data-target="#quickViewModal"> Xem
                                                                        nhanh</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row" id="product-list-list">
                                            @foreach ($sanpham as $sp)
                                                <div class="product_list_item mb-35 product-item"
                                                    data-id="{{ $sp->idsp }}" data-idlsp="{{ $sp->idlsp }}"
                                                    data-idth="{{ $sp->idth }}"
                                                    data-idkt="{{ $sp->chitietsanpham->pluck('idkt')->implode(',') }}"
                                                    data-idm="{{ $sp->chitietsanpham->pluck('idm')->implode(',') }}"
                                                    data-price="{{ $sp->gia }}">
                                                                ...
                                                                <div class="content_price">
                                                                    <span>
                                                                        @if ($sp->giamgia->phantram > 0)
                                                                            ...
                                                                            <span class="price-old"
                                                                                style="text-decoration: line-through; color: gray; font-size: 16px; ">
                                                                                {{ number_format($sp->gia) }} đ
                                                                            </span>
                                                                        @else
                                                                            <span class="price-new"
