                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mt-5" style="margin-top: 35px; display: flex;">
                            <div class="col-6"s
                                ...
                                <br>
                                <span>
                                    <a style="color: white !important;" ssss="mailto:{{ $hoadon->khachhang->email }}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($chitiethoadon as $cthd)
                                        @foreach ($cthd->chitietsanpham as $ctsp)
                                            <tr>
                                                <td
                                                    style="border-top: 1px solid #dee2e6; padding: 5px 0; color: #000000;">
                                                    {{ $ctsp->sanpham->ten }}
                                                    (Màu: {{ $ctsp->mau->ten }}, Size:
                                                    {{ $ctsp->kichthuoc->ten }})
                                                    x {{ $cthd->soluong }}
                                                </td>
                                                <td
                                                    ...
                                                    @php
                                                        ...
                                                        $tong += $tongtien * $cthd->soluong;
                                                    @endphp
                                                    <b>{{ number_format($tongtien * $cthd->soluong) }}đ</b>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endforeach
