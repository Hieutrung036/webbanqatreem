...
class dathangnotloginController extends Controller
{
    public function xulydathangnotlogin(Request $request)
    {
        ...
        if ($phuongthuc->ten != 'VNPay') {
            Mail::to($email)->send(new ThongBaoDonHangNotLoginMail1($hoadon, $chitiethoadon));
